   ...
   <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-static-top navbar-dark bg-gradient-x-grey-blue navbar-border navbar-brand-center">
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="/"><img class="brand-logo" alt="stack admin logo" src="<?php echo e(asset('app-assets/images/logo/stack-logo-light.png')); ?>">
    ...
    <!-- END: Header--><?php /**PATH /home/tanvir/LARAVEL/weTrack/resources/views/layouts/app_header.blade.php ENDPATH**/ ?>