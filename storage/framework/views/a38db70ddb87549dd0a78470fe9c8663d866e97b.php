				...
				<div class="row">
					<div class="col-md-6">
						...
						<fieldset class="form-group floating-label-form-group">
								...
								<input type="text" class="form-control" id="e_name" name="full_name" placeholder="Enter Employee Name" required data-validation-required-message="This field is required">
						</fieldset>
					</div>
