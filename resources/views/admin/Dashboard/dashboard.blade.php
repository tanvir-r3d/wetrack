...
@section('script')
    ...
    <script defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDDXkzEIj9sB3J_ohqT0woVWqAJQiyRmAE&libraries=places&callback=initMap"></script>
    <script>
        ...
        @php $employees=collect($employee)->where('emp_status','on')->sortByDesc('infield')->take(7); @endphp
