                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                         ...
                         <select class="form-control" id="exampleFormControlSelect1" name="branch_id">
                           @foreach(App\Branch::orderBy('branch_name','asc')->get() as $branch)
                       ...
                       <div class="form-group">
                            ...
                            <select class="form-control" id="exampleFormControlSelect1" name="branch_cat">
                              @foreach(App\EmployeeCategory::orderBy('emp_cat_name','asc')->get() as $employee)
                             <option value="{{ $branch->branch_id}}">{{ $employee->emp_cat_name}}</option>
                             @endforeach
                            </select>
                          </div>
